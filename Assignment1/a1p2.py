...
def encrypt(message: str, key: str):
    ...
    for symbol in message:
        if symbol in LETTERS:
            ...
            key = LETTERS.find(symbol) # Make the current symbol the key for next itteration
...
def decrypt(message: str, key: str):
    ...
    for symbol in message:
        if symbol in LETTERS:
            ...
            key = LETTERS.find(LETTERS[num]) # Make the current symbol the key for next itteration
